...
- **合格確率推移**: 過去30日間の合格確率の変動を折れ線グラフで表示
...
│   └── probability-chart.tsx # 合格確率推移グラフ
├── lib/
│   ├── supabase/            # Supabaseクライアント
│   ├── probability.ts       # 合格確率計算ロジック
...
### 合格確率計算（第1段階：プレースホルダー）
- 計算ロジックは`lib/probability.ts`に集約
- 第1段階ではシンプルな実装で、後から改善可能な設計
- 基礎学力、学習時間、放置時間を考慮した計算式（第2段階で本実装予定）
- **範囲**: 0-99%で表示
